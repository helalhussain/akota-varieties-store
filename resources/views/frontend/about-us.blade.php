...
@section('content')
            ...
            <section class="tf-section flat-our">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 ">
                            <div class="box">
                                <div class="title title-36 fw-7 text-color-6"> Our Mission </div>
                                <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour,
                                    or randomised words which don't look even believable. If you are going to use a passage of Lorem Ipsum,</p>
                                <h4 class="fw-6">There are many variations of passages of Lorem Ipsum available, but the majority have suffered some form, by injected humour,
                                    or randomised words which don't look even believable.</h4>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="box box-2">
                                <div class="title title-36 fw-7 text-color-6"> Our Vission</div>
                                <h4 class="fw-6">There are many variations of passages of Lorem Ipsum available, but the majority have suffered some form, by injected humour, or randomised words which don't look even believable.</h4>
                                <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour,
                                    or randomised words which don't look even believable. If you are going to use a passage of Lorem Ipsum,</p>
                            </div>
                        </div>
            ...
            <section class="flat-count"><div class="overlay"></div>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="themes-count tf-counter flex-one">
                                <div class="counter-box">
                                    <div class="content wow fadeInUp" data-wow-delay="0ms" data-wow-duration="2000ms">
                                        <div class="count-number"><div class="number number-style number-one" data-speed="2000" data-to="1" data-inviewport="yes"></div></div>
                                        <h3 class="title-count fw-5">Satisfied Clients</h3>
                                    </div>
                                </div>
                                <div class="counter-box">
                                    <div class="content wow fadeInUp" data-wow-delay="0ms" data-wow-duration="2000ms">
                                        <div class="count-number "><div class="number" data-speed="2000" data-to="678" data-inviewport="yes">678</div></div>
                                        <h3 class="title-count fw-5">Expert Team</h3>
                                    </div>
                                </div>
                                <div class="counter-box">
                                    <div class="content wow fadeInUp" data-wow-delay="0ms" data-wow-duration="2000ms">
                                        <div class="count-number "><div class="number" data-speed="2000" data-to="285" data-inviewport="yes">285 </div></div>
                                        <h3 class="title-count fw-5">Activate Products</h3>
                                    </div>
                                </div>
                                <div class="counter-box">
                                    <div class="content wow fadeInUp" data-wow-delay="0ms" data-wow-duration="2000ms">
                                        <div class="count-number"><div class="number" data-speed="2000" data-to="15" data-inviewport="yes">15 </div></div>
                                        <h3 class="title-count fw-5">Awards Winning</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section class="tf-section flat-about page">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-md-7">
                            <div class="wrap-about">
                                <div class="heading-section">
                                    <h5>Why Choose Us</h5>
                                    <h2>Organic & Helathy Foods
                                        Provider Farming</h2>
                                    <p>There are many variations of passages of Lorem Ipsum available, majority have suffered alteration in some form, by injected randomised words which don't look even believable. </p>
                                </div>
                                <div class="flex box-icon">
                                    ...
                                    <div class="content">
                                        <h3 class="link-style-1"><a href="#">Agriculture & Foods</a> </h3>
                                        <p>Nemo enim ipsam voluptatem quia voluptas sit fugit, sed quia consequuntur</p>
                                    </div>
                                </div>
                                <div class="flex box-icon">
                                    <div class="icon">
                                    ...
                                    <div class="content">
                                        <h3 class="link-style-1"><a href="#">Vegetables & Fruits</a> </h3>
                                        <p>Nemo enim ipsam voluptatem quia voluptas sit fugit, sed quia consequuntur</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-5">
                            <div class="relative wrap-img center">
                                <div class="images image-1">
                                    <img src="{{ asset('frontend') }}/assets/images/img-box/about-5.jpg" alt="images">
                                </div>
                                <div class="images image-2">
                                    <img src="{{ asset('frontend') }}/assets/images/img-box/about-6.jpg" alt="images">
                                </div>
                               <div class="mark-image">
                                    <img src="{{ asset('frontend') }}/assets/images/mark/mark-about.png" alt="images">
                               </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="flat-icon page">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4 col-md-4">
                            <div class="box-icon">
                                <div class="icon">
                                    <img class="img" src="{{ asset('frontend') }}/assets/images/icon/icon-5.png" alt="images">
                                </div>
                                <div class="content">
                                    <h3 class="link-style-6"><a href="#">Creative Design</a> </h3>
                                    <p> Lorem ipsum dolor sit amet, incididunt ut labore et dolore magna aliqua.ipsum suspendisse ultrices gravida.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4">
                            <div class="box-icon">
                                <div class="icon style-2">
                                    <img class="img" src="{{ asset('frontend') }}/assets/images/icon/icon-6.png" alt="images">
                                </div>
                                <div class="content">
                                    <h3 class="link-style-1"><a href="#">100% Money Back Guarantee</a> </h3>
                                    <p> Lorem ipsum dolor sit amet, incididunt ut labore et dolore magna aliqua.ipsum suspendisse ultrices gravida.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4">
                            <div class="box-icon">
                                <div class="icon">
                                    <img class="img" src="{{ asset('frontend') }}/assets/images/icon/icon-7.png" alt="images">
                                </div>
                                <div class="content">
                                    <h3 class="link-style-6"><a href="#">Online Support 24/7</a> </h3>
                                    <p> Lorem ipsum dolor sit amet, incididunt ut labore et dolore magna aliqua.ipsum suspendisse ultrices gravida.</p>
                                </div>
                            </div>
                        </div>
            ...
            <section class="tf-section flat-video-page">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="flat-video page"><div class="overlay"></div>
                                <div class="relative video-box center">
                                    <div class="heading-section style">
                                        <h5>How Can We Help</h5>
                                        <h2 class="text-color-1">Awesome Solutions 100% Success</h2>
                                    </div>
            ...
            <section class="flat-team center">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="heading-section">
                        ...
                        <div class="col-lg-12">
                            <div class="wrap-team">
                                <div class="swiper-container carousel-team">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="box-team box-hv">
                                                <div class="images hover-style hv-2">
                                                    <img src="{{ asset('frontend') }}/assets/images/img-box/team-1.jpg" alt="">
                                                    <div class="content">
                                                        <h5 class="fw-6">Admin</h5>
                                                        <h3 class="link-style-3"><a href="team.html">Richard L. McDonald</a> </h3>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="box-team box-hv ">
                                                <div class="images hover-style hv-2">
                                                    <img src="{{ asset('frontend') }}/assets/images/img-box/team-2.jpg" alt="">
                                                    <div class="content">
                                                        <h5 class="fw-6">Admin</h5>
                                                        <h3 class="link-style-3"><a href="team.html">Richard L. McDonald</a> </h3>
                                                        <div class="icon-social link-style-6">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="box-team box-hv">
                                                <div class="images hover-style hv-2">
                                                    <img src="{{ asset('frontend') }}/assets/images/img-box/team-3.jpg" alt="">
                                                    <div class="content">
                                                        <h5 class="fw-6">Admin</h5>
                                                        <h3 class="link-style-3"><a href="team.html">Richard L. McDonald</a> </h3>
                                                        <div class="icon-social link-style-6">
            ...
            <section class="tf-section2 flat-testimonials center"><div class="overlay"></div>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="heading-section">
                                <h5 class="">Customer Reviews</h5>
                                <h2 class="text-color-1">What People Say</h2>
                            </div>
                            <div class="swiper-container carousel-2" data-aos="fade-up" data-aos-duration="2000">
                                <div class="swiper-wrapper slider-style">
                                    <div class="swiper-slide">
                                        <div class="box-testi">
                                            <img class="img-testi" src="{{ asset('frontend') }}/assets/images/icon/icon-testi.png" alt="images">
                                            <h5 class="text-color-4">Nemo enim ipsam voluptatem quia voluptas sit aspernatur odit aut fugit, sed quia consequuntur magni voluptatem of sequi nesciunt. Neque porro quisquam est,</h5>
                                            <div class="author">
                                                <div class="images-author">
                                                    <img src="{{ asset('frontend') }}/assets/images/img-box/testi-1.jpg" alt="images">
                                                </div>
                                                <h4 class="text-color-1 fw-6">Nicolas Markus</h4>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="box-testi">
                                            ...
                                            <div class="author">
                                                <div class="images-author">
                                                    <img src="{{ asset('frontend') }}/assets/images/img-box/testi-2.jpg" alt="images">
                                                </div>
                                                <h4 class="text-color-1 fw-6">Nika Khanna</h4>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
            ...
            <section class="tf-section2 flat-icon page2 center">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="heading-section">
                                <h5 class="">Our Farm</h5>
                                <h2 class="text-unset">We Care for Nature</h2>
                                <p>Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni </p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4">
                            <div class="box-icon box-1">
                                <div class="icon">
                                    <img class="img" src="{{ asset('frontend') }}/assets/images/icon/icon-8.png" alt="images">
                                </div>
                                <div class="content">
                                    <h3 class="link-style-6"><a href="#">Delivery at Door Step</a> </h3>
                                    <p> Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4">
                            <div class="box-icon box-2">
                                <div class="icon style-2">
                                    <img class="img" src="{{ asset('frontend') }}/assets/images/icon/icon-9.png" alt="images">
                                </div>
                                <div class="content">
                                    <h3 class="link-style-1"><a href="#">Certified Organic Products</a> </h3>
                                    <p> Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4">
                            <div class="box-icon box-3">
                                <div class="icon">
                                    <img class="img" src="{{ asset('frontend') }}/assets/images/icon/icon-10.png" alt="images">
                                </div>
                                <div class="content">
                                    <h3 class="link-style-6"><a href="#">Farm Fresh Produced</a> </h3>
                                    <p> Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. </p>
                                </div>
                            </div>
                        </div>
