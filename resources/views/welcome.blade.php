...
@section('content')
                            ...
                            <div class="slider-item">
                                <div class="flat-slider">
                                    <div class="img-slider">
                                        <img class="img-item" src="{{ asset('frontend') }}/assets/images/slider/slider-01.jpg" alt="">
                                    </div>
                                    <div class="container">
                                        <div class="content">
                                            <div class="heading">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="box-icon">
                                <div class="icon">
                                    <img class="img" src="{{ asset('frontend') }}/assets/images/icon/icon-1.png" alt="images">
                                </div>
                                <div class="content">
                                    <h3 class="link-style-6"><a href="#">Fresh from Nutrition</a> </h3>
                                    <p> Duis aute irure dolor in derit in voluptate velit esse cillum dolore eu fugiat nulla</p>
                                    <div class="meta link-style-6">
                                        <a href="#" class="btn-button flex fw-5 j-content">Read More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="box-icon">
                                <div class="icon style-2">
                                    <img class="img" src="{{ asset('frontend') }}/assets/images/icon/icon-2.png" alt="images">
                                </div>
                                <div class="content">
                                    <h3 class="link-style-1"><a href="#">100% Organic</a> </h3>
                                    <p> Duis aute irure dolor in derit in voluptate velit esse cillum dolore eu fugiat nulla</p>
                                    <div class="meta">
                                        <a href="#" class="btn-button flex fw-5 j-content">Read More</a>
                                    </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="box-icon">
                                <div class="icon">
                                    <img class="img" src="{{ asset('frontend') }}/assets/images/icon/icon-3.png" alt="images">
                                </div>
                                <div class="content">
                                    <h3 class="link-style-6"><a href="#">Premium Quality</a> </h3>
                                    <p> Duis aute irure dolor in derit in voluptate velit esse cillum dolore eu fugiat nulla</p>
                                    <div class="meta link-style-6">
                                        <a href="#" class="btn-button flex fw-5 j-content">Read More</a>
                                    </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="box-icon">
                                <div class="icon style-2">
                                    <img class="img" src="{{ asset('frontend') }}/assets/images/icon/icon-4.png" alt="images">
                                </div>
                                <div class="content">
                                    <h3 class="link-style-1"><a href="#">100% Natural Products</a> </h3>
                                    <p> Duis aute irure dolor in derit in voluptate velit esse cillum dolore eu fugiat nulla</p>
                                    <div class="meta">
                                        <a href="#" class="btn-button flex fw-5 j-content">Read More</a>
                                    </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-md-5">
                            <div class="wrap-img">
                                <img class="img-1" src="{{ asset('frontend') }}/assets/images/img-box/about-1.jpg" alt="images">
                                <img class="img-2" src="{{ asset('frontend') }}/assets/images/img-box/about-2.jpg" alt="images">
                                <div class="box-author">
                                    <div class="title title-30 fw-6">Our started the journey in 1990 Most 450k Clients Satisfied With Us</div>
                                    <div class="inner flex">
                                        <div class="author"><img src="{{ asset('frontend') }}/assets/images/img-box/about-author2.jpg" alt="images"></div>
                                        <div class="content">
                                            <h3>Nicolas Marko</h3>
                                            <div class="fs-16">Founder of CEO</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-7">
                            <div class="wrap-about">
                                ...
                                <div class="box-icon flex">
                                    ...
                                    <div class="content">
                                        <h3 class="link-style-1"><a href="about.html">Agriculture & Foods</a> </h3>
                                ...
                                <div class="box-icon flex">
                                    ...
                                    <div class="content">
                                        <h3 class="link-style-1"><a href="about.html">Vegetables & Fruits</a> </h3>
                                        <p>Nemo enim ipsam voluptatem quia voluptas sit fugit, sed quia consequuntur</p>
                                    </div>
                                </div>

                                <div class="buttons">
                                    <a class="blob-btn btn-style" href="about.html">
                                        Read More
                                        <span class="blob-btn__inner">
                                        <span class="blob-btn__blobs">
                                            <span class="blob-btn__blob"></span>
            ...
            <section class="tf-section2 flat-vegetables">
                <div class="mark-img style-01"><img src="{{ asset('frontend') }}/assets/images/mark/mark-1.png" alt="images"></div>
                <div class="container">
                    <div class="row">
                                ...
                                <div class="content-tab">
                                    <div class="content-inner tab-content">
                                        <div class="wrap-vegetables flex">
                                            <div class="box box-hv">
                                                <div class="images hover-style">
                                                    <a href="product-details.html"><img src="{{ asset('frontend') }}/assets/images/img-box/food-1.png" alt="images"></a>
                                                    <div class="icon-list flex">
                                                        <a class="icon-1" href="#"><i class="far fa-search"></i></a>
                                                        <a class="icon-2" href="#"><i class="fas fa-shopping-basket"></i></a>
                                                        <a class="icon-3" href="#"><i class="far fa-heart"></i></a>
                                                    </div>
                                                ...
                                                <div class="content">
                                                    ...
                                                    <h3 class="link-style-6"><a href="product-details.html">Chiken Egg</a> </h3>
                                                    <div class="money">
                                                        <span class="one">$15</span> <span class="two">$10</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="box box-hv">
                                                <div class="images hover-style">
                                                    <a href="product-details.html"><img src="{{ asset('frontend') }}/assets/images/img-box/food-2.png" alt="images"></a>
                                                    <div class="icon-list flex">
                                                        <a class="icon-1" href="#"><i class="far fa-search"></i></a>
                                                        <a class="icon-2" href="#"><i class="fas fa-shopping-basket"></i></a>
                                                        <a class="icon-3" href="#"><i class="far fa-heart"></i></a>
                                                    </div>
                                                    <div class="tag-text style"> Sale </div>
                                                </div>
                                                <div class="content">
                                                    <div class="star">
                                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"	 viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve"><g>	<g>		<polygon points="512,197.816 325.961,185.585 255.898,9.569 185.835,185.585 0,197.816 142.534,318.842 95.762,502.431 			255.898,401.21 416.035,502.431 369.263,318.842 		"/>	</g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g></svg>
                                                    ...
                                                    <h3 class="link-style-6"><a href="product-details.html">Fresh Carrots</a> </h3>
                                                    <div class="money">
                                            ...
                                            <div class="box box-hv">
                                                <div class="images hover-style">
                                                    <a href="product-details.html"><img src="{{ asset('frontend') }}/assets/images/img-box/food-3.png" alt="images"></a>
                                                    <div class="icon-list flex">
                                                        <a class="icon-1" href="#"><i class="far fa-search"></i></a>
                                                        <a class="icon-2" href="#"><i class="fas fa-shopping-basket"></i></a>
                                                        <a class="icon-3" href="#"><i class="far fa-heart"></i></a>
                                                ...
                                                <div class="content">
                                                    ...
                                                    <h3 class="link-style-6"><a href="product-details.html">Organic Brocolli</a> </h3>
                                                    <div class="money">
                                                        <span class="one">$15</span> <span class="two">$10</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="box box-hv">
                                                <div class="images hover-style">
                                                    <a href="product-details.html"><img src="{{ asset('frontend') }}/assets/images/img-box/food-4.png" alt="images"></a>
                                                    <div class="icon-list flex">
                                                        <a class="icon-1" href="#"><i class="far fa-search"></i></a>
                                                        <a class="icon-2" href="#"><i class="fas fa-shopping-basket"></i></a>
                                                        <a class="icon-3" href="#"><i class="far fa-heart"></i></a>
                                                    </div>
                                                    <div class="tag-text style"> Fress</div>
                                                </div>
                                                <div class="content">
                                                    <div class="star">
                                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"	 viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve"><g>	<g>		<polygon points="512,197.816 325.961,185.585 255.898,9.569 185.835,185.585 0,197.816 142.534,318.842 95.762,502.431 			255.898,401.21 416.035,502.431 369.263,318.842 		"/>	</g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g></svg>
                                                    ...
                                                    <h3 class="link-style-6"><a href="product-details.html">Fresh Gooseberry</a> </h3>
                                                    <div class="money">
                                                        <span class="one">$15</span> <span class="two">$10</span>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="buttons center">
                                            <a class="blob-btn btn-style" href="shop-grid.html">
                                                View More
                                                <span class="blob-btn__inner">
                                                <span class="blob-btn__blobs">
                                                    <span class="blob-btn__blob"></span>
                                    ...
                                    <div class="content-inner tab-content">
                                        <div class="wrap-vegetables flex">
                                            <div class="box box-hv wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1000ms">
                                                <div class="images hover-style">
                                                    <a href="product-details.html"><img src="{{ asset('frontend') }}/assets/images/img-box/food-5.png" alt="images"></a>
                                                    <div class="icon-list flex">
                                                        <a class="icon-1" href="#"><i class="far fa-search"></i></a>
                                                        <a class="icon-2" href="#"><i class="fas fa-shopping-basket"></i></a>
                                                        <a class="icon-3" href="#"><i class="far fa-heart"></i></a>
                                            ...
                                            <div class="box box-hv  wow zoomIn" data-wow-delay="0ms" data-wow-duration="1000ms">
                                                <div class="images hover-style">
                                                    <a href="product-details.html"><img src="{{ asset('frontend') }}/assets/images/img-box/food-6.png" alt="images"></a>
                                                    <div class="icon-list flex">
                                                        <a class="icon-1" href="#"><i class="far fa-search"></i></a>
                                                        <a class="icon-2" href="#"><i class="fas fa-shopping-basket"></i></a>
                                                        <a class="icon-3" href="#"><i class="far fa-heart"></i></a>
                                            ...
                                            <div class="box box-hv wow zoomIn" data-wow-delay="0ms" data-wow-duration="1000ms">
                                                <div class="images hover-style">
                                                    <a href="product-details.html"><img src="{{ asset('frontend') }}/assets/images/img-box/food-7.png" alt="images"></a>
                                                    <div class="icon-list flex">
                                                        <a class="icon-1" href="#"><i class="far fa-search"></i></a>
                                                        <a class="icon-2" href="#"><i class="fas fa-shopping-basket"></i></a>
                                                        <a class="icon-3" href="#"><i class="far fa-heart"></i></a>
                                            ...
                                            <div class="box box-hv wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1000ms">
                                                <div class="images hover-style">
                                                    <a href="product-details.html"><img src="{{ asset('frontend') }}/assets/images/img-box/food-8.png" alt="images"></a>
                                                    <div class="icon-list flex">
                                                        <a class="icon-1" href="#"><i class="far fa-search"></i></a>
                                                        <a class="icon-2" href="#"><i class="fas fa-shopping-basket"></i></a>
                                                        <a class="icon-3" href="#"><i class="far fa-heart"></i></a>
                                    ...
                                    <div class="content-inner tab-content">
                                        <div class="wrap-vegetables flex">
                                            <div class="box box-hv wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1000ms">
                                                <div class="images hover-style">
                                                    <a href="product-details.html"><img src="{{ asset('frontend') }}/assets/images/img-box/food-12.png" alt="images"></a>
                                                    <div class="icon-list flex">
                                                        <a class="icon-1" href="#"><i class="far fa-search"></i></a>
                                                        <a class="icon-2" href="#"><i class="fas fa-shopping-basket"></i></a>
                                                        <a class="icon-3" href="#"><i class="far fa-heart"></i></a>
                                    ...
                                    <div class="content-inner tab-content">
                                        <div class="wrap-vegetables flex">
                                            ...
                                            <div class="box box-hv  wow zoomIn" data-wow-delay="0ms" data-wow-duration="1000ms">
                                                <div class="images hover-style">
                                                    <a href="product-details.html"><img src="{{ asset('frontend') }}/assets/images/img-box/food-9.png" alt="images"></a>
                                                    <div class="icon-list flex">
                                                        <a class="icon-1" href="#"><i class="far fa-search"></i></a>
                                                        <a class="icon-2" href="#"><i class="fas fa-shopping-basket"></i></a>
                                                        <a class="icon-3" href="#"><i class="far fa-heart"></i></a>
                                            ...
                                            <div class="box box-hv wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1000ms">
                                                <div class="images hover-style">
                                                    <a href="product-details.html"><img src="{{ asset('frontend') }}/assets/images/img-box/food-10.png" alt="images"></a>
                                                    <div class="icon-list flex">
                                                        <a class="icon-1" href="#"><i class="far fa-search"></i></a>
                                                        <a class="icon-2" href="#"><i class="fas fa-shopping-basket"></i></a>
                                                        <a class="icon-3" href="#"><i class="far fa-heart"></i></a>
                                    ...
                                    <div class="content-inner tab-content">
                                        <div class="wrap-vegetables flex">
                                            <div class="box box-hv wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1000ms">
                                                <div class="images hover-style">
                                                    <a href="product-details.html"><img src="{{ asset('frontend') }}/assets/images/img-box/food-11.png" alt="images"></a>
                                                    <div class="icon-list flex">
                                                        <a class="icon-1" href="#"><i class="far fa-search"></i></a>
                                                        <a class="icon-2" href="#"><i class="fas fa-shopping-basket"></i></a>
                                                        <a class="icon-3" href="#"><i class="far fa-heart"></i></a>
            ...
            <section class="tf-section2 flat-sale">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="heading-section">
                                <h5>35% Off For vegetables</h5>
                                <h2>Mega Sale On vegetables Category</h2>
                                <h3 class="fw-5">limited quantities only in the first week of June</h3>
                            </div>
                            <div class="wrap-sale">
                                <div class="box-count">
                                    <ul class="flex-five">
                                ...
                                <div class="buttons">
                                    <a class="blob-btn btn-style btn-1" href="shop-grid.html">
                                        Shop Now
                                        <span class="blob-btn__inner">
                                        <span class="blob-btn__blobs">
                                            <span class="blob-btn__blob"></span>
            ...
            <section class="tf-section2 flat-organic">
                <div class="mark-img style-02"><img src="{{ asset('frontend') }}/assets/images/mark/mark-1.png" alt="images"></div>
                <div class="mark-img style-03"><img src="{{ asset('frontend') }}/assets/images/mark/mark-1.png" alt="images"></div>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="heading-section center">
                                <h5>Organic Products</h5>
                                <h2>Nutrition Organic Product</h2>
                            </div>
                        </div>

                        <div class="col-lg-6 col-md-6">
                            <div class="box-organic box-1">
                                <div class="title fw-5">Nutrition Organic</div>
                                <div class="images hover-img3 ">
                                    <div class="img-style3" ><img src="{{ asset('frontend') }}/assets/images/img-box/organic-1.jpg" alt="images"></div>
                                    <div class="content">
                                        <div class="sub-title text-color-3 title-30 fw-5">Fresh Food</div>
                                        <div class="title-h3"><a href="shop-left-sidebar.html">Organic Food</a> </div>
                                        <div class="buttons">
                                            <a class="blob-btn" href="shop-left-sidebar.html">
                                                Shop Now
                                                <span class="blob-btn__inner">
                                                <span class="blob-btn__blobs">
                                                    <span class="blob-btn__blob"></span>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="box-organic box-2">
                                <div class="title fw-5">Super Protein</div>
                                <div class="images hover-img3">
                                    <div class="img-style3" ><img src="{{ asset('frontend') }}/assets/images/img-box/organic-2.jpg" alt="images"></div>
                                    <div class="content">
                                        <div class="sub-title text-color-3 title-30 fw-5">Fresh Fruits</div>
                                        <div class="title-h3"><a href="shop-left-sidebar.html">Organic Fruits</a> </div>
                                        <div class="buttons">
                                            <a class="blob-btn" href="shop-left-sidebar.html">
                                                Shop Now
                                                <span class="blob-btn__inner">
            ...
            <section class="tf-section flat-video"><div class="overlay"></div>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="video-box center">
                                <div class="heading-section style">
                                    <h5>100% Organics</h5>
                                    <h2 class="text-color-1">Daily Fresh & Healthy </h2>
                                </div>
            ...
            <section class="tf-section2 flat-arrivals">
                <div class="mark-img style-04"><img src="{{ asset('frontend') }}/assets/images/mark/mark-1.png" alt="images"></div>
                <div class="mark-img style-05"><img src="{{ asset('frontend') }}/assets/images/mark/mark-1.png" alt="images"></div>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="heading-section center">
                                <h5>Organics Products</h5>
                                <h2 class="">New Arrivals goods </h2>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="box-arrivals flex hover-img2">
                                <div class="images img-style2">
                                    <a href="product-details.html"><img src="{{ asset('frontend') }}/assets/images/img-box/arrivals-1.png" alt="images"></a>
                                </div>
                                <div class="content">
                                    <div class="tag-text">Fress</div>
                                    <h3 class="link-style-1"><a href="product-details.html">Vegan Fresh Tomato</a> </h3>
                                    <div class="money">
                                        <span>$87.00 <span class="text-money"> (Per Kg)</span></span>
                                    </div>
                                    <p>Sumptuous, filling, and temptingly healthy, our Biona Organi</p>
                                    <div class="star">
                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"	 viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve"><g>	<g>		<polygon points="512,197.816 325.961,185.585 255.898,9.569 185.835,185.585 0,197.816 142.534,318.842 95.762,502.431 			255.898,401.21 416.035,502.431 369.263,318.842 		"/>	</g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g></svg>
                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"	 viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve"><g>	<g>		<polygon points="512,197.816 325.961,185.585 255.898,9.569 185.835,185.585 0,197.816 142.534,318.842 95.762,502.431 			255.898,401.21 416.035,502.431 369.263,318.842 		"/>	</g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g></svg>
                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"	 viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve"><g>	<g>		<polygon points="512,197.816 325.961,185.585 255.898,9.569 185.835,185.585 0,197.816 142.534,318.842 95.762,502.431 			255.898,401.21 416.035,502.431 369.263,318.842 		"/>	</g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g></svg>
                                    ...
                                    <div class="wrap-list flex">
                                        ...
                                        <div class="icon">
                                            <a class="icon-1" href="#"><i class="fas fa-shopping-basket"></i></a>
                                            <a class="icon-2" href="#"><i class="far fa-heart"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="box-arrivals flex hover-img2">
                                <div class="images img-style2">
                                    <a href="product-details.html"><img src="{{ asset('frontend') }}/assets/images/img-box/arrivals-2.png" alt="images"></a>
                                </div>
                                <div class="content">
                                    <div><span class="tag-text">Fress</span><span class="tag-text style">-30%</span></div>
                                    <h3 class="link-style-1"><a href="product-details.html"> Vege Fruit Bucket</a></h3>
                                    <div class="money">
                                        <span class="one text-color-4"><del>$280.00 </del> </span> <span>$135.00 <span class="text-money"> (Per Kg)</span></span>
                                    </div>
                                    <p>Sumptuous, filling, and temptingly healthy, our Biona Organi</p>
                                    <div class="star">
                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"	 viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve"><g>	<g>		<polygon points="512,197.816 325.961,185.585 255.898,9.569 185.835,185.585 0,197.816 142.534,318.842 95.762,502.431 			255.898,401.21 416.035,502.431 369.263,318.842 		"/>	</g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g></svg>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="box-arrivals flex hover-img2">
                                <div class="images img-style2">
                                    <a href="product-details.html"><img src="{{ asset('frontend') }}/assets/images/img-box/arrivals-3.png" alt="images"></a>
                                </div>
                                <div class="content">
                                    <div class="tag-text">Fress</div>
                                    <h3 class="link-style-1"><a href="product-details.html">Red Fresh Apple</a> </h3>
                                    <div class="money">
                                        <span>$87.00 <span class="text-money"> (Per Kg)</span></span>
                                    </div>
                                    <p>Sumptuous, filling, and temptingly healthy, our Biona Organi</p>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="box-arrivals flex hover-img2">
                                <div class="images img-style2">
                                    <a href="product-details.html"><img src="{{ asset('frontend') }}/assets/images/img-box/arrivals-4.png" alt="images"></a>
                                </div>
                                <div class="content">
                                    <div><span class="tag-text">Fress</span><span class="tag-text style">-30%</span></div>
                                    <h3 class="link-style-1"><a href="product-details.html">Vege Fruit Bucket</a> </h3>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="buttons center">
                                <a class="blob-btn btn-style" href="shop-list-sidebar.html">
                                    View More
                                    <span class="blob-btn__inner">
                                    <span class="blob-btn__blobs">
                                        <span class="blob-btn__blob"></span>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6 col-lg-5 col-md-12">
                            <div class="heading-section">
                                <h5 class="">Subsrribe Here</h5>
                                <h2 class="text-color-1">Subscribe To Newsletter</h2>
                                <h4 class="fw-4 text-color-1">Duis aute irure dolor in reprehenderit in voluptate velit dolore eu fugiat nulla pariatur.</h4>
                            </div>
                        </div>
                            ...
                            <div class="widget-subcribe">
                                <div class="form-subcribe">
                                    <form id="subscribe-form" action="#" method="GET" accept-charset="utf-8" class="form-submit flex">
                                        <input name="email" value="" class="email" type="email" placeholder="Email Address" required>
                                        <button id="submit" name="submit" type="submit">
                                            <span>Subsrcribe Now</span>
                                        </button>
                                    </form>
                                </div>
                            </div>
            ...
            <section class="tf-section2 flat-gallery">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="heading-section">
                                <h5 class="">Photo Gallery</h5>
                                <h2>Insite Photo Gallery</h2>
                            </div>
                            <div class="swiper-container carousel show-boder " data-aos="fade-up" data-aos-duration="2000">
                                <div class="swiper-wrapper slider-style">
                                    <div class="swiper-slide">
                                        <div class="box-gallery hover-img">
                                            <div class="images img-style">
                                                <img src="{{ asset('frontend') }}/assets/images/img-box/gallery-1.jpg" alt="images">
                                                <div class="content flex-two">
                                                    <div class="inner">
                                                        <h3 class="link-style-1"><a href="project-details.html">Organic Fruits Juice</a> </h3>
                                                        <p class="font">Fresh Food & Vegetable</p>
                                                    </div>
                                                    <div class="button-box">
                                                        <a class="button-btn" href="project-details.html"><i class="fas fa-arrow-right"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box-gallery hover-img">
                                            <div class="images img-style">
                                                <img src="{{ asset('frontend') }}/assets/images/img-box/gallery-2.jpg" alt="images">
                                                <div class="content flex-two">
                                                    <div class="inner">
                                                        <h3 class="link-style-1"><a href="project-details.html">Organic Fruits Juice</a> </h3>
                                                        <p class="font">Fresh Food & Vegetable</p>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box-gallery hover-img">
                                            <div class="images img-style">
                                                <img src="{{ asset('frontend') }}/assets/images/img-box/gallery-3.jpg" alt="images">
                                                <div class="content flex-two">
                                                    <div class="inner">
                                                        <h3 class="link-style-1"><a href="project-details.html">Organic Fruits Juice</a> </h3>
                                                        <p class="font">Fresh Food & Vegetable</p>
                            ...
                            <div class="swiper-container carousel-4">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="blog-box tf-img hover-img hv-one">
                                            <a class="media img-style" href="blog-details.html">
                                                <img class="img-item" src="{{ asset('frontend') }}/assets/images/blog/blog-1.jpg" alt="">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="blog-box tf-img hover-img hv-one">
                                            <a class="media img-style" href="blog-details.html">
                                                <img class="img-item" src="{{ asset('frontend') }}/assets/images/blog/blog-2.jpg" alt="">
                                                <span class="hover-one"></span>
                                            </a>
                                            <div class="content">
                                                <div class="days absolute"><div class="number">10</div> <div class="titles">June</div> </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="blog-box tf-img hover-img hv-one">
                                            <a class="media img-style" href="blog-details.html">
                                                <img class="img-item" src="{{ asset('frontend') }}/assets/images/blog/blog-3.jpg" alt="">
                                                <span class="hover-one"></span>
                                            </a>
                                            <div class="content">
                                                <div class="days absolute"><div class="number">10</div> <div class="titles">June</div> </div>
